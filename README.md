...
Тренировки. Большой забег. Онлайн-интенсивы.
Сборник материалов для подготовки к техсобеседованию в Яндекс.

## Структура коммитов

```text
[Тип] Курс_Модуль_Задача: Краткое описание
```

### Типы коммитов:

- `Add` - добавление новой задачи/решения
- `Fix` - исправление в существующем коде/тексте
- `Update` - обновление/улучшение решения
- `Refactor` - рефакторинг кода
- `Style` - изменения форматирования, пробелы
