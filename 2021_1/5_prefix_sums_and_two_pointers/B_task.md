...
**Алгоритм:** Метод двух указателей с префиксными суммами

**Суть:** Поиск всех подмассивов с заданной суммой $K$ путём поддержания скользящего окна и использования префиксных сумм для эффективного вычисления сумм подмассивов.
