...
1. Инициализируем левый указатель в 0 и пустое окно    
2. Для каждого правого указателя от 0 до N-1:    
    - Добавляем дерево в окно        
    - Если в окне есть все K типов:        
        - Запоминаем это окно, если оно короче лучшего            
        - Двигаем левый указатель вправо, пока в окне остаются все K типов           
        - Запоминаем каждое новое окно, если оно короче            

**Сложность**: O(N) - каждый элемент добавляется и удаляется не более одного раза.