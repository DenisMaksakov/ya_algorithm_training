...
1. **Построение словаря ударений**:
   - Для каждого слова из словаря сохраняем все варианты с ударениями
   - Ключ - слово в нижнем регистре, значение - список вариантов с ударениями

2. **Проверка текста**:
   - Разбиваем текст на слова
   - Для каждого слова:
     - **Если слово есть в словаре**: проверяем, совпадает ли вариант Пети с одним из допустимых вариантов
     - **Если слова нет в словаре**: проверяем, что в слове ровно одна заглавная буква (ровно одно ударение)

3. **Подсчет ошибок**:
   - Увеличиваем счетчик, когда:
     - Слово есть в словаре, но вариант Пети не совпадает ни с одним допустимым
     - Слова нет в словаре, и в нем не ровно одно ударение

**Сложность**: $O(N + M)$, где $N$ - количество слов в словаре, $M$ - количество слов в тексте.